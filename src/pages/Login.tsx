  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex w-1/2 bg-zinc-950 relative overflow-hidden flex-col justify-between p-12 text-white">
        <div className="absolute inset-0 bg-gradient-to-br from-primary/20 to-transparent z-0 pointer-events-none" />
        ...
        <div className="relative z-10 mt-auto text-sm text-zinc-500 font-medium tracking-wide">
